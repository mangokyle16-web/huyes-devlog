#!/usr/bin/env python3
"""
Append and update VNIR calibration rows.

Examples:
  python3 spectral_capture/tools/calib_logger.py append --cube /dev/shm/vnir_bands.bin
  python3 spectral_capture/tools/calib_logger.py append --weight 61.2
  python3 spectral_capture/tools/calib_logger.py set-weight 20260613_153012 61.2
"""
...
from spectral_capture.pipeline.band_extract import extract_batch_features, load_band_cube
